...
# Forecast lead times required for Day 1-Day 10
FORECAST_HOURS = [
    6,
    24,
    48,
...
print("=" * 65)
print("GFS JUNE 2022 - DAY 1 TO DAY 10 DOWNLOAD")
print("=" * 65)
